...
class BustersAgent:
    ...
    def getAction(self, gameState):
        "Updates beliefs, then chooses an bestAction based on updated beliefs."
...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        not yet been captured, then chooses an bestAction that brings
        ...
        for dist in livingGhostPositionDistributions:
            ...
            for pos in dist.keys():
                if dist[pos] > maxPos:
                    maxPos = dist[pos]
                    tempPos = pos
            tempDistance = self.distancer.getDistance(pacmanPosition, tempPos)
            if tempDistance < distance:
                distance = tempDistance
                ghost_position = tempPos
